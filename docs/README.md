...
How to run td-gui and what every screen does. If you have never started it,
...
td did not offer it. If a metadata row is absent, the field is unset. Nothing
here is filled in with a placeholder or a guess.

Design notes for how each feature was built live in
