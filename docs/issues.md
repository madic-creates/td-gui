...
One request carries at most 1000 issues, which is td's own cap. If the
project has more, a note above the list says how many of how many are shown,
and the filters are how you narrow it.
